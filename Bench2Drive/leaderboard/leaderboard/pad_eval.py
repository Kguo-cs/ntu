...
CHECKPOINT_ENDPOINT=os.environ["SAVE_PATH"]+"eval.json"
...
TEAM_CONFIG=Bench2Drive_ROOT +"leaderboard/pad_team_code/pad_config.py+/home/users/ntu/lyuchen/scratch/keguo_projects/ntu/exp/ke/B2d32_acclocal0_2000/02.11_10.50/lightning_logs/version_0/checkpoints/epoch=6-step=5376.ckpt"
...
def main():
    ...
    parser.add_argument('--port', default=20008, type=int,
                        help='TCP port to listen to (default: 2000)')
    parser.add_argument('--traffic-manager-port', default=50008, type=int,
    ...
    parser.add_argument("-a", "--agent", type=str,default=TEAM_AGENT,
                        help="Path to Agent's py file to evaluate")
    parser.add_argument("--agent-config", type=str,default=TEAM_CONFIG,
    ...
    parser.add_argument("--checkpoint", type=str, default=CHECKPOINT_ENDPOINT,
