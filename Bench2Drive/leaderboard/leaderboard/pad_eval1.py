...
os.environ["SAVE_PATH"] = "./eval_pad1/"
...
#95 3800
TEAM_AGENT=Bench2Drive_ROOT +"leaderboard/pad_team_code/pad_b2d_agent1.py"
...
if not os.path.exists("./eval_pad1/"):
    os.mkdir("./eval_pad1/")
...
def main():
    ...
    parser.add_argument('--traffic-manager-port', default=50002, type=int,
