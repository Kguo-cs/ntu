...
if [ ! -d "eval_bench2drive220_${ALGO}_${PLANNER_TYPE}" ]; then
    mkdir eval_bench2drive220_${ALGO}_${PLANNER_TYPE}
    echo -e "\033[32m Directory eval_bench2drive220_${ALGO}_${PLANNER_TYPE} created. \033[0m"
else
    echo -e "\033[32m Directory eval_bench2drive220_${ALGO}_${PLANNER_TYPE} already exists. \033[0m"
fi
...
CHECKPOINT_ENDPOINT="eval_bench2drive220_${ALGO}_${PLANNER_TYPE}/${BASE_CHECKPOINT_ENDPOINT}_$2.json"
GPU_RANK=$2
...
echo -e "***********************************************************************************"
bash -e leaderboard/scripts/run_evaluation.sh $PORT $TM_PORT $IS_BENCH2DRIVE $ROUTES $TEAM_AGENT $TEAM_CONFIG $CHECKPOINT_ENDPOINT $SAVE_PATH $PLANNER_TYPE $GPU_RANK  2>&1 > ${BASE_ROUTES}_$2_$3_${ALGO}_${PLANNER_TYPE}.log &
sleep 250